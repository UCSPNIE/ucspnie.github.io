            ...
            <div className="cards-row">
                <div className="container">
                    <div class='card'>
                        ...
                        <div class='content'>
                            <h3>Vision</h3>
                            <p>To build a research environment for inspiring minds and to embark intellectual circuit in the years to come. </p>
                        </div>
                    </div>
                </div>
                <div className="container">
                    <div class='card'>
                        ...
                        <div class='content'>
                            <h3>Motto</h3>
                            <p>To see what everyone has seen, but to think what nobody else has thought to create a positive impact on the society. </p>
                        </div>
                    </div>
                </div>
                <div className="container">
                    <div class='card'>
                        ...
                        <div class='content'>
                            <h3>Goal</h3>
                            <p>To create awareness and keen interest in today's trending technologies and to orient the students and faculties alike to undertake research in their selected areas of interest. </p>
                        </div>
                    </div>
                </div>
            </div>
